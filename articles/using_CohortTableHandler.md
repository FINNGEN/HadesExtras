...
#> attempting to extract and load: /tmp/RtmpbjX9jv/GiBleed_5.3.zip to: /tmp/RtmpbjX9jv/GiBleed_5.3.sqlite
```
...
#> Inserting data took 0.00827 secs
...
#> Executing SQL took 0.0393 secs
...
#> Executing SQL took 0.0373 secs
#> Generating cohort set took 0.55 secs
#> getCohortDemograpics took 0.103 secs
```
...
#> 2
#> Inserting data took 0.00769 secs
...
#> Counting cohorts took 0.015 secs
#> getCohortDemograpics took 0.0766 secs
```
