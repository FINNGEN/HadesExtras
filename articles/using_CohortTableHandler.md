...
#> attempting to extract and load: /tmp/RtmpbTnEgB/GiBleed_5.3.zip to: /tmp/RtmpbTnEgB/GiBleed_5.3.sqlite
```
...
#> Inserting data took 0.00877 secs
...
#> Executing SQL took 0.0367 secs
...
#> Generating cohort set took 0.34 secs
#> getCohortDemograpics took 0.14 secs
```
...
#> Generating cohort set took 0.1 secs
#> Counting cohorts took 0.0172 secs
#> getCohortDemograpics took 0.0971 secs
```
