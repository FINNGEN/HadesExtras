...
test_that("CohortDiagnostics_mergeCsvResults copies CSV results if only one folder", {

  temp_dir <- tempdir()
  result_folder1 <- file.path(temp_dir, "result_folder0")
  merged_results_folder <- file.path(temp_dir, "merged_results0")
