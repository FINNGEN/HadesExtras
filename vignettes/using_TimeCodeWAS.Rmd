...
```{r}
listAnalyses <- list(
  analysisDetails_ConditionOccurrenceConceptSource,
  analysisDetails_DrugExposureConceptSource,
  analysisDetails_ProcedureOccurrenceConceptSource,
  analysisDetails_MeasurementConceptSource,
  analysisDetails_DeviceExposureConceptSource,
  analysisDetails_ObservationConceptSource
)
